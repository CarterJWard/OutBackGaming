...
_query = format["INSERT INTO gas (pid, pos, owned) VALUES('%1', '%2', '1')",_uid,_housePos];
...
_query = format["SELECT id FROM gas WHERE pos='%1' AND pid='%2' AND owned='1'",_housePos,_uid];
