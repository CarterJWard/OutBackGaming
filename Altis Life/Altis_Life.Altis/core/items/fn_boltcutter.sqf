...
if (((nearestObject [[16019.5,16952.9,0],"Land_Dome_Big_F"]) isEqualTo _building || (nearestObject [[16019.5,16952.9,0],"Land_Research_house_V1_F"]) isEqualTo _building) && (west countSide playableUnits < (LIFE_SETTINGS(getNumber,"minimum_cops")))) exitWith {
