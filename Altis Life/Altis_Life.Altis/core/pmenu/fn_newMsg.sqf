...
{ 
	...
	case 1: { 
		...
		if(_msg == "") exitWith {hint "You must enter a message to be sent!";ctrlShow[88885, true];};
	...
	case 2: { 
		...
		if(_msg == "") exitWith {hint "You must enter a message to be sent!";ctrlShow[888895,true];};
	...
	case 3: { 
		...
		if(_msg == "") exitWith {hint "You must enter a message to be sent!";ctrlShow[888896,true];};
	...
	case 4: { 
		...
		if(_msg == "") exitWith {hint "You must enter a message to be sent!";ctrlShow[888899,true];};
